...
def ssim(img1, img2, window_size=11, window=None, size_average=True, full=False, val_range=1):
    ...
    img1 = torch.clamp(img1.clone(),0,1)
    img2 = torch.clamp(img2.clone(),0,1)
...
class SSIM(torch.nn.Module):
    def __init__(self, branch='diffuse',target='diffuse', window_size=11, size_average=True, val_range=None):
    ...
    def forward(self, _output, _input):
        ...
        img1 = _output[self.branch]
        img2 = _input[self.target]
